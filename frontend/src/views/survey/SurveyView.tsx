...
export function SurveyView({
  ...
  return (
    <article className="phase-card survey-card">
      <div className="snapshot-pill">Phase: Survey</div>
      <h2>Survey View</h2>
      <p className="phase-copy">
        Prepare the survey brief, inspect generated theme clusters and sections, then
        approve or revise the final Markdown survey.
      </p>
      ...
      <section className="panel-stack">
        <section className="action-panel">
          <div className="panel-header">
            ...
            <span className="helper-copy">
              brief {snapshot.survey_summary.brief_ready ? "ready" : "pending"} - clusters {snapshot.survey_summary.cluster_count}
            </span>
          </div>
          <div className="brief-grid">
            <div>
              <label className="field-label" htmlFor="survey-angle">
                Survey angle
              </label>
              <input
                id="survey-angle"
            ...
            <div>
              <label className="field-label" htmlFor="survey-audience">
                Audience
              </label>
              <input
                id="survey-audience"
          ...
          <label className="field-label" htmlFor="survey-emphasis">
            Emphasis
          </label>
          <input
            id="survey-emphasis"
            ...
            disabled={busy}
          />
          <label className="field-label" htmlFor="survey-comparisons">
        ...
        <section className="survey-summary-grid">
          ...
          <article className="summary-tile">
            ...
            <strong>{snapshot.survey_summary.markdown_ready ? "ready" : "pending"}</strong>
          </article>
          <article className="summary-tile">
